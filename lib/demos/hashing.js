...
export const hashingDemo = {
  ...
  blurb: "Open addressing: collisions probe forward to the next empty slot; the table doubles past load factor 0.5, and delete re-inserts the rest of the cluster (Sedgewick's algorithm, no tombstones).",
