...
export const quicksortDemo = {
  ...
  blurb: "Pick the last element as pivot; scan left-to-right swapping everything smaller into a growing boundary, then drop the pivot at that boundary — its final sorted position. Recurse on both sides.",
  make: () => new Sorting(),
  initial: "5,2,8,1,9,3,7,4,6",
  renderer: (c) => new ArrayRenderer(c, { mode: "cells" }),
